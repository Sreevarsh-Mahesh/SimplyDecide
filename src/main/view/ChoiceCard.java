...
public class ChoiceCard extends JPanel {
    ...
    public ChoiceCard(Choice choice, DBManager dbManager, Consumer<Boolean> onSelectionChanged) {
        ...
        JScrollPane prosScroll = new JScrollPane(prosPanel);
        prosScroll.setBorder(null);
        prosScroll.setBackground(Color.WHITE);
        prosContainer.add(prosLabel, BorderLayout.NORTH);
        prosContainer.add(prosScroll, BorderLayout.CENTER);
        ...
        JScrollPane consScroll = new JScrollPane(consPanel);
        consScroll.setBorder(null);
        consScroll.setBackground(Color.WHITE);
        consContainer.add(consLabel, BorderLayout.NORTH);
        consContainer.add(consScroll, BorderLayout.CENTER);
